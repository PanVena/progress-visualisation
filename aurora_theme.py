"""
Midnight Aurora Theme definition
"""
...
AURORA_THEME = {
    ...
    'subtext': '#94a3b8',         # Slate blue-grey
    'subtext_dim': '#475569',      # Deep slate
    
    # Accent colors (Sophisticated & Vibrant)
    'accent': '#06b6d4',          # Cyan Sparkle
    'success': '#10b981',         # Emerald Glow
    'warning': '#f59e0b',         # Ember
    'error': '#f43f5e',           # Rose flare
    'info': '#8b5cf6',            # Violet glow
    
    # Aurora Palette (Multi-tone)
    'aurora_teal': '#2dd4bf',
    'aurora_indigo': '#6366f1',
    'aurora_purple': '#a855f7',
    'aurora_rose': '#fb7185',
    
    # UI elements
    'border': '#1e293b',          # Subtle Border
    'hover': '#1e1b4b',           # Dark Indigo hover
    'pressed': '#312e81',         # Dark Indigo press
    
    # Progress (Gradient Bases)
    'progress_translated': '#06b6d4',
    'progress_approved': '#8b5cf6',
